...
| ----- | ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Linux | amd64        | [rust-template-0.3.0-x86_64-linux.tar.xz](https://github.com/spotdemo4/rust-template/releases/download/v0.3.0/rust-template-0.3.0-x86_64-linux.tar.xz)     |
| Linux | arm64        | [rust-template-0.3.0-aarch64-linux.tar.xz](https://github.com/spotdemo4/rust-template/releases/download/v0.3.0/rust-template-0.3.0-aarch64-linux.tar.xz)   |
| MacOS | arm64        | [rust-template-0.3.0-aarch64-darwin.tar.xz](https://github.com/spotdemo4/rust-template/releases/download/v0.3.0/rust-template-0.3.0-aarch64-darwin.tar.xz) |

### Docker

```elm
docker run ghcr.io/spotdemo4/rust-template:0.3.0
```
...
```yaml
- name: rust template
  uses: docker://ghcr.io/spotdemo4/rust-template:0.3.0
```
